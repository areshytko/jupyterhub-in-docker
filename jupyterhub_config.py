...
c.Authenticator.admin_users = {'areshytko', 'amin'}
...
#  Default: '/home/vagrant/.local/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/vagrant/.local/share/jupyterhub'
...
import yaml
with open("images.yml") as rf:
    c.DockerSpawner.image_whitelist = yaml.load(rf)
c.DockerSpawner.remove_containers = True
#c.DockerSpawner.extra_create_kwargs = {'user': 'root'}
c.DockerSpawner.extra_host_config = {'runtime': 'nvidia'}
c.Spawner.environment = {'GRANT_SUDO': 'yes'}
c.DockerSpawner.volumes = {
    '/raid/jupyterhub/{username}': '/home/ubuntu/workspace',
}
